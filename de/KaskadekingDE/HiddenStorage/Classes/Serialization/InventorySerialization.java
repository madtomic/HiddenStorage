package de.KaskadekingDE.HiddenStorage.Classes.Serialization;
...
public class InventorySerialization {
    ...
    public String Serialize(Inventory inv) {
        String json = de.KaskadekingDE.HiddenStorage.Classes.Serialization.JSON.InventorySerialization.serializeInventoryAsString(inv);
        return ToBase64(json);
    }

    public Inventory Deserialize(String base64) {
        String json = FromBase64(base64);
        return Helper.InventoryFromItemStack(de.KaskadekingDE.HiddenStorage.Classes.Serialization.JSON.InventorySerialization.getInventory(json, 54));
    }
