package de.KaskadekingDE.HiddenStorage.Classes.Serialization.JSON;

import de.KaskadekingDE.HiddenStorage.Classes.Serialization.JSON.json.*;
...
public class SingleItemSerialization {
  ...
  /**
   * Serialize an ItemStack that is inside an inventory. An extra "index" key will be added to store
   * the position of the ItemStack in the inventory
   *
  ...
  /**
   * Deserialize an ItemStack. An index if given strictly for debug purposes. When an error message
   * is given the index will be used for more useful reference
   *
   * @param item  The ItemStack to deserialize
